...
def main():
    ...
    PATH_TO_SX_DUMP = Path("/home/njainiitp/projects/google_qa/lmtraining/data/input/sx_dump")
    ...
    #download_and_unzip_data(main_url=MAIN_URL, links=links[1:SAMPLE], path_to_dump=PATH_TO_SX_DUMP)
