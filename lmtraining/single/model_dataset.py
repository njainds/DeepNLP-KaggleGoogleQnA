...
class QuestDataset(torch.utils.data.Dataset):
    def __init__(self, df=None, tokenizer=None, target_cols = None, max_len=512, content="Question_Answer",augment = True,labeled=True):
        self.df = df
    ...
    def trim_input(self, title, body, answer, max_seq_len = 512, t_max_len =30, q_max_len = int((512-30-4)/2), a_max_len = 512-30-4-int((512-30-4)/2), num_token = 4):
